...
当前公开目标是 `v0.1.0`：面向已有数据库日志文件、导出记录、捕获流或各 backend
已文档化 live source 用户的首个可用 tag 集合。首个 tag 发布前，建议使用检出的分支
进行评估。已发布能力和待补能力以 [`ROADMAP.md`](../ROADMAP.md#capability-matrix)
中的能力矩阵为准。
...
当前公开目标：`v0.1.0`，首个可用 developer preview tag 集合。
