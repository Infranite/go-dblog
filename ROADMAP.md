...
| `v0.3.0` | Planned | Remaining live reader | PostgreSQL wire-level logical replication protocol reader. | The reader implements `dblog.Decoder`, supports context cancellation, and has integration tests isolated from unit tests. |
...
- Keep contribution guidance in `README.md`; do not add a standalone
  `CONTRIBUTING.md` unless the onboarding process outgrows that section.
