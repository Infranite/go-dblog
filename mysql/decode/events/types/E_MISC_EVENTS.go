...
func init() {
	_ = Register(new(StartEventV3))
	_ = Register(new(StopEvent))
	_ = Register(new(LoadEvent))
	_ = Register(new(FileEvent))
	_ = Register(new(ExecLoadEvent))
	_ = Register(new(RandEvent))
	_ = Register(new(UserVarEvent))
	_ = Register(new(ExecuteLoadQueryEvent))
	_ = Register(new(IncidentEvent))
	_ = Register(new(HeartbeatEvent))
	_ = Register(new(RowsQueryEvent))
	_ = Register(new(GTIDLogEvent))
	_ = Register(new(PreviousGTIDsEvent))
	_ = Register(new(TransactionContextEvent))
	_ = Register(new(ViewChangeEvent))
	_ = Register(new(XAPrepareLogEvent))
	_ = Register(new(TransactionPayloadEvent))
}
